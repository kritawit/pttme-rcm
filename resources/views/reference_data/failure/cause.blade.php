...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Reference Data - Failure Cause</li>
        </ol>
    </section>
      ...
      <div class="col-md-12">
        <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Reference Data - Failure Cause</h3>
                ...
                {!! Form::open(array('url'=>'reference-data/failure/cause','class'=>'form-horizontal','role'=>'form')) !!}
                <fieldset>
                <div class="form-group">
                  {!! Form::label('description','Failure Cause : ',array('class'=>'col-lg-2 control-label')) !!}
                        <div class="col-lg-4">
                    ...
                    <table id="tb-failure-cause" class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" onclick="desTroy({{$cause->id}});return false;"><span class="fa fa-trash-o text-danger"></span></a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Edit Failure Cause</h4>
        </div>
