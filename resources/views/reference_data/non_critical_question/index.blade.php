...
<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Reference Data - Non Critical Question</li>
        </ol>
</section>
      ...
      <div class="col-md-12">
        <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Reference Data - Non Critical Question</h3>
               ...
               {!! Form::open(array('url'=>'reference-data/non-critical-question/add','class'=>'form-horizontal','role'=>'form')) !!}
                <fieldset>
              ...
              <hr>
                <div>
                    <table id="tb-non-list" class="table table-hover">
                      <thead>
                      <tr>
                          <th>Active</th>
                          <th class="text-center">Non Critical Question</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Edit Non Critical Question</h4>
        </div>
...
<script type="text/javascript">
  ...
  function deleteRef() {
	...
	function getEdit(id){
    $.ajax({
      url: '{{url()}}/reference-data/non-critical-question/edit',
      type: 'GET',
  ...
  function desTroy(id){
    if(confirm("Are you sure you want to delete?")){
    	window.location.href = "{{url()}}/reference-data/non-critical-question/destroy?id="+id;
    }
  }
  function deleteSelect(id){
    $.ajax({
      url: '{{url()}}/reference-data/non-critical-question/destroy',
      type: 'GET',
      data: {'id':id, '_token': $('input[name=_token]').val()}
    });
  }
