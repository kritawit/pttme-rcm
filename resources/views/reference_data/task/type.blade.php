...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Reference Data - Task Type</li>
        </ol>
    </section>
      ...
      <div class="col-md-12">
        <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Reference Data - Task Type</h3>
                ...
                @endif
                {!! Form::open(array('url'=>'reference-data/task/type','class'=>'form-horizontal','role'=>'form')) !!}
                <fieldset>
                <div class="form-group">
                  {!! Form::label('description','Task Type : ',array('class'=>'col-lg-2 control-label')) !!}
                        <div class="col-lg-4">
  ...
  function deleteRef() {
    ...
    function getEdit(id){
    $.ajax({
      url: '{{url()}}/reference-data/task/edittype',
      type: 'POST',
  ...
  function desTroy(id){
    if(confirm("Are you sure you want to delete?")){
      $.ajax({
      url: '{{url()}}/reference-data/task/destroytype',
      type: 'POST',
      data: {'id':id, '_token': $('input[name=_token]').val()},
      success:function(data){
        if(data='success'){
