...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Reference Data - Task List</li>
        </ol>
    </section>
      ...
      <div class="col-md-12">
        <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Reference Data - Task List</h3>
                ...
                {!! Form::open(array('url'=>'reference-data/task/list','class'=>'form-horizontal','role'=>'form')) !!}
                <fieldset>
                <div class="form-group">
                  {!! Form::label('description','Task List : ',array('class'=>'col-lg-2 control-label')) !!}
                        <div class="col-lg-4">
              ...
              <div class="col-sm-12">
                <div>
                    <table id="tb-task-list" class="table table-hover">
                      <thead>
                      <tr>
  ...
  $(function() {
    $("#tb-task-list").DataTable();
  });
  function getEdit(id){
    $.ajax({
      url: '{{url()}}/reference-data/task/editlist',
      type: 'POST',
  ...
  function desTroy(id){
    if(confirm("Are you sure you want to delete?")){
      $.ajax({
      url: '{{url()}}/reference-data/task/destroylist',
      type: 'POST',
      data: {'id':id, '_token': $('input[name=_token]').val()},
      success:function(data){
        if(data='success'){
