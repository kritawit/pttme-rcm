...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
           ...
           <li class="active">Report - By Equipment Type And Failure Effect</li>
         </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Report - By Equipment Type And Failure Effect</h3>
                ...
                @endif
                {!! Form::open(array('url'=>'report/typefailureeffect','class'=>'form-horizontal','role'=>'form')) !!}
                <fieldset>
                  <div class="form-group">
                  <label for="stu_title" class="col-lg-2 control-label"><b>Equipment Type : </b></label>
                    <div class="col-lg-4" id="classrm">
                        {!! Form::select('type_id',['' => 'Select All']+ $types,null,['class'=>'form-control select2']) !!}
                    </div>
                  </div>
                  <div class="form-group">
