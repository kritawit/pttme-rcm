...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
           ...
           <li class="active">Report - By Equipment Categorise</li>
         </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Report - By Equipment Categorise</h3>
                ...
                <div class="form-group">
                  <label for="stu_title" class="col-lg-2 control-label"><b>Equipment Category : </b></label>
                        <div class="col-lg-4" id="gradename">
                          {!! Form::select('category_id',['' => 'Select All']+ $categories,null,['class'=>'form-control select2']) !!}
                        </div>
                  </div>
                  <div class="form-group">
